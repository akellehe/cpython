...
PyParser_SimpleParseStringFlags(const char *str, int start, int flags)
{
    perrdetail err;
    node *n; 
    printf("SimpleeParseStringFlags\n");
                                        ...
                                        int start, int flags)
{
    perrdetail err;
    node *n; 
    printf("SimpleParseSstringFlagsFilename\n");
...
{
    printf("SimpleParseStringFilename\n");
